...
export default function RootLayout() {
  ...
  useEffect(() => {
    ...
    // Guard the wins and decision-helper routes: if no token exists, send them back to the start/login
    if (!hasToken && (currentSegment === 'wins' || currentSegment === 'decision-helper')) {
