      ...
      <View className="mb-6">
        ...
        {sectionWins.map(win => {
          ...
          return (
            <View 
              key={win.id} 
              className={`flex-row justify-between items-center ${itemBg} border border-primary p-3.5 mt-2 rounded-none`}
            >
      ...
      <ScrollView className="flex-1 px-4 py-3" style={{ marginBottom: BottomTabInset }} showsVerticalScrollIndicator={false}>
        ...
        <NeobrutalistCard containerClassName="mb-8" cardClassName="p-5" borderColor="border-primary" shadowColor="bg-primary">
          ...
          <View className="flex-row justify-between items-center mb-2">
            <Text className="text-primary text-3xl font-black uppercase tracking-tighter">Weekly Wins</Text>
          ...
          <View className="mb-6">
            ...
            <View className="mb-4 relative z-50">
              ...
              {dropdownOpen && (
                <View className="absolute top-[50px] left-0 right-0 bg-white border-2 border-primary rounded-none z-50 shadow-[3px_3px_0px_0px_#0F1739]">
                  {(['Easy', 'Moderate', 'Challenging'] as const).map(option => (
                    ...
                    >
                      <Text className="text-primary font-bold text-sm">{option}</Text>
                    </TouchableOpacity>
                  ))}
                </View>
              )}
          ...
          {loading ? (
            ...
            <View className="py-12 items-center justify-center bg-slate-50 border-2 border-dashed border-primary rounded-none">
              <Text className="text-primary text-center font-black text-sm mb-1 uppercase">Weekly Wins Not Found 👻</Text>
