  ...
  return (
    ...
    >
      ...
      >
        {/* FRONT SIDE (SHUTTER) */}
        <div
          className="absolute inset-x-0 top-0 h-[40px] z-20 bg-zinc-900 overflow-hidden shadow-xl cursor-pointer group [backface-visibility:hidden]"
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-between px-6 md:px-12 pb-1.5">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 md:w-3 md:h-3 rounded-full bg-red-600 animate-pulse shadow-[0_0_8px_rgba(220,38,38,0.8)]" />
                <span className="text-[8px] md:text-[10px] text-zinc-500 uppercase font-black tracking-widest">
                  Privacy Active
                </span>
              </div>
            </div>
        ...
        <div className="absolute inset-0 w-full h-full [backface-visibility:hidden] [transform:rotateX(180deg)]">
          ...
          <button
            ...
            className="absolute top-4 md:top-1/2 md:-translate-y-1/2 right-4 md:right-8 p-2 text-white hover:text-zinc-400 transition-colors z-30"
            title="Hide Tracker"
          >
