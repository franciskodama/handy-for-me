      ...
      <Card>
        ...
        <CardContent className="flex">
          ...
          <div>
            ...
            <div>
              ...
              <h3>
                {weather.main ? <p>{Math.trunc(weather.main.temp)}°C</p> : null}
              </h3>
            </div>
            <div>
              <h4>Wind</h4>
            ...
            <div>
              <h4>Pressure</h4>
              <h3>{weather.main ? <p>{weather.main.pressure}</p> : null}</h3>
              <h5>kPa</h5>
            </div>

            <div>
              <h4>Humidity</h4>
              <h3>{weather.main ? <p>{weather.main.humidity}</p> : null}</h3>
              <h5>%</h5>
            </div>
        ...
        <CardFooter className="flex justify-between items-start">
          ...
          <div className="flex flex-col gap-2 text-xs">
            <p>Longitude {weather.coord ? <p>{weather.coord.lon}</p> : null}</p>
            <p>Latitude {weather.coord ? <p>{weather.coord.lat}</p> : null}</p>
          </div>
        </CardFooter>
      </Card>
    </>
