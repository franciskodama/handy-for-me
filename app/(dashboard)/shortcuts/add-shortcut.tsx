...
export function AddShortcut({
  ...
  const handleDeleteShortcut = async (category: ShortcutCategory) => {
    try {
    ...
    <Sheet>
      ...
      <SheetContent side="right" className="sm:max-w-xs mt-8 gap-8">
        <div className="flex flex-col gap-2 my-8">
          ...
          <p className="text-sm font-normal lowercase">Create a new Shortcut</p>
        </div>
        <form
          action={action}
        ...
        {/* <div className="flex flex-col gap-2 my-8">
          ...
          {shortcuts.map((category: ShortcutCategory) => (
            <div
              key={category.id}
