...
const kudos = [
  ...
  'You are a language ninja! 🥷 Your skills are sharp and impressive.',
...
function KudosMessage({ name }: { name: string }) {
  ...
  useEffect(() => {
    ...
    switch (true) {
      case chosen > 1 / 2:
        selectedMessage = `${name}, ${kudos[0]}`;
        break;
      case chosen > 1 / 4:
        selectedMessage = `${name}, ${kudos[1]}`;
        break;
      case chosen > 1 / 8:
        selectedMessage = `${name}, ${kudos[2]}`;
        break;
      case chosen > 1 / 16:
        selectedMessage = `${name}, ${kudos[3]}`;
        break;
      case chosen > 1 / 32:
        selectedMessage = `${name}, ${kudos[4]}`;
        break;
      case chosen > 1 / 64:
        selectedMessage = `${name}, ${kudos[5]}`;
        break;
      case chosen > 1 / 128:
        selectedMessage = `${name}, ${kudos[6]}`;
        break;
      case chosen > 1 / 256:
        selectedMessage = `${name}, ${kudos[7]}`;
        break;
      case chosen > 1 / 512:
        selectedMessage = `${name}, ${kudos[8]}`;
        break;
      default:
        selectedMessage = `${name}, ${kudos[9]}`;
    }
